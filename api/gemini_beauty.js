...
export default async function handler(req, res) {
    ...
    try {
        ...
        const stylePrompts = {
            ...
            snowstory: `電影分鏡圖 (Film Storyboard)，唯美冬季攝影風格，透明雨傘道具，三格連貫分鏡：
              1️⃣ 中景特寫，人物望向遠方。
              2️⃣ 遠景，站在雪地中央，環境廣闊。
              3️⃣ 超特寫，人物直視鏡頭，柔焦雪花。
              色調冷色系，飄雪細膩夢幻，8K。`,
            pure: "使用上傳圖片中的人物，保持原始光影但自動美膚補強，微調光線、提升膚色自然感、保留真實細節，乾淨背景。AI 自動補光修飾。",
            k_id: "韓系證件照風格，白色背景、柔光均勻、清晰面部五官、自然微笑、乾淨妝感，8K。",
            ...
            storyboard: `電影分鏡圖 (Film Storyboard)，Ethereal winter photography style。
              三格構圖描繪人物在雪地中，冷色調、夢幻光線、高解析。`
